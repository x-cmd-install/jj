...
[![x-cmd/install — jj Code Quality Monitoring Repo Card](https://repo.x-cmd.io/jj.svg?lang=zh)](https://x-cmd.com/install/jj)
...
合计: **234,026** 行代码（覆盖前 5 种语言、共 **525** 个文件）。
...
- **上游仓库**: <https://github.com/jj-vcs/jj>
- **官网**: <https://jj-vcs.dev>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v0.45.1` (2026-09-03)
- **最近提交**: 2026-09-20
- **Release 含资产**: 7 个

## 流行度

- **Star**: 31,662 · **Fork**: 1,224 · **开放 issue**: 2,240 · **贡献者**: 380

## 累计统计

- **发布数**: 53 · **已合并 PR**: 6074 · **开放 PR**: 442 · **已关闭 issue**: 1429 · **开放 issue**: 811 · **提交数**: 11728
...
jj 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `jj` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/jj.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260920.yml` · 2026-09-20T05:13:01Z._
